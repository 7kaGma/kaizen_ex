    ...
    <x-content-frame>
        <div>
            ...
            <div class="flex w-full h-scleen">
                ...
                <div class=" w-1/2 rounded-l-xl h-scleen">
                    <div class="mx-2">
                ...
                <div class=" w-1/2 rounded-r-xl h-scleen">
                    <div class="mx-2">
                        <div class="flex">
                            <div class="w-1/2">
                                <h2 class="font-bold mx-auto">提案者</h2>
                                <div class="text-center border mx-auto w-4/5 px-1 py-1   text-black mb-2 w-full">{!! $post->name !!}</div>
                            </div>
                            <div class="w-1/2">
                                <h2 class="font-bold mx-auto">提案日時</h2>
                                <div class="text-center border mx-auto w-4/5 px-1 py-1   text-black mb-2 w-full">{!! $post->updated_at->format('Y-m-d H:i') !!}</div>
                            </div>
                        </div>
                        ...
                        <div class="flex">
                            <div class="w-1/3">
                                ...
                                <div class="text-center border mx-auto w-4/5 px-1 py-1   text-black mb-2 w-full"> {!! $post->position !!}</div>
                            </div>
                            <div class="w-1/3">
                                <h2 class="font-bold">部署名</h2>
                                <div class="text-center border mx-auto w-4/5 px-1 py-1   text-black mb-2 w-full"> {!! $post->department !!}</div>
                            </div>
                            <div class="w-1/3">
                                <h2 class="font-bold">チーム</h2>
                                <div class="text-center border mx-auto w-4/5 px-1 py-1   text-black mb-2 w-full">{!! $post->team !!}</div>
                            </div>
                        </div>
                        <div class="flex justify-end">
                            <div class="w-1/3">
                                ...
                                <div>
                                    <div class="text-center w-3/5 px-1 py-3 border rounded-md text-black mb-2 w-full">{!! $post->goodCounts !!}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class=" mx-1 my-1">  
                            <div class="">
                                ...
                                <textarea class="bg-gray-100 mb-2 px-1 rounded-md w-full" type="text" name="bossComment" rows="7" cols="" required >{{ $post->bossComment }}</textarea>
                            </div>
                            <div class="flex">
                                <div class="w-1/4 mx-auto">
                                    <h2 class="font-bold text-red-500">現在の承認状態</h2>
                                    <div class="text-center w-3/5 px-1 py-1  border rounded-md text-black mb-2 w-full">{!! $post->approvalStage !!}</div>
                                </div>
                                <div class="w-3/5 mx-auto">
                                    <div class="font-bold text-blue-600">判断をお願いします</div>
                                    <div class="flex justify-evenly rounded-lg bg-gray-100 border  my-1 py-1 ">  
